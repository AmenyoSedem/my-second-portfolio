      ...
      <div className="">
            <form className='mt-40 mb-20 text-center justify-center' action="https://formspree.io/f/mvgpdoaz" method='post'>
                <div className="my-10">
                    ...
                    <input className='text-xl text-neutral-400 bg-transparent border border-neutral-500 rounded-2xl p-2 pl-5 py-3 h-14' type="text" name='name' id='name'  placeholder='Name' required/>
                </div>

                <div className="py-10">
                    <label htmlFor="name" hidden>Email</label>
                    <input className='text-xl text-neutral-400 bg-transparent border border-neutral-500 rounded-2xl pl-5 py-3 h-14' type="Email" name='email' id='email'  placeholder='Email' required/>
                </div>
